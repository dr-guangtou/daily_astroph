...
#### [Unveiling the dynamical state of massive clusters through the ICL fraction](https://arxiv.org/abs/1803.04981)
    ...
    * we find a higher ICL fraction in the F606W filter for the merging clusters, consistent with an excess of lower-metallicity/younger stars in the ICL
...
#### [X-ray scaling relations from a complete sample of the richest maxBCG clusters](https://arxiv.org/abs/1803.05007)
    ...
    * Meanwhile, they follow normal LX −TX and LX −YX relations, which suggests that they are normal X-ray clusters.
...
#### [Revisiting the Cooling Flow Problem in Galaxies, Groups, and Clusters of Galaxies](https://arxiv.org/abs/1803.04972)
    - **Important, Relevant**
    * 对cooling rate > 30 Msun/yr的星系: measure a slope in the SFR–M ̇ cool relation greater than unity, suggesting that the systems with the strongest cool cores are also cooling more efficiently. 冷却率低的星系里没有这个相关
    * Higher black hole accretion rates in the strongest cool cores, which could influence the total amount (saturating near the Eddington rate) and dominant mode (mechanical vs radiative) of feedback.
...
#### [The Origin of Faint Tidal Features Around Galaxies in the RESOLVE Survey](https://arxiv.org/abs/1803.05447)
    ...
    * These results suggest TFs in gas-poor galaxies are typically streams/shells from dry mergers or satellite disruption.
